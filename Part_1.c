...
int main(int argc, char *argv[])
{
    ...
    if (strncmp(argv[1], "direct", 6)==0) { /* Simulating direct-mapped cache */
        ...
        double Total_Memory_access;
        Total_Memory_access = d_cache.hits + d_cache.misses;
        Cache_hitrate = d_cache.hits/Total_Memory_access;
        Cache_missrate = d_cache.misses/Total_Memory_access;
